...
const JoinTeam = () => {
  return (
    <div className="FYQNNZHFGW" data-aos="fade-up">
      <div className="BQLREHNGBT">
        <div className="NDRZTVMCBP">
          <span className="FUURNMKULQ">
            We'll take the time to understand your goals and then help you
            create a website that's exactly what you envisioned.
          </span>
          <span className="ENAICNENQV">
